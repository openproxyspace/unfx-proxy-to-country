...
const Footer = () => (
    <div className="footer">
        <div className="marks">
            ...
            <span className="product-name">Unfx proxy to country</span>
            <span className="version">v{currentVersion}</span>
        </div>
        <div className="socials">
            ...
            <a title="Github Page">
                <svg xlinkHref="https://github.com/assnctr/unfx-proxy-to-country" onClick={openLink} className="github-svg" x="0px" y="0px" viewBox="0 0 90 90">
